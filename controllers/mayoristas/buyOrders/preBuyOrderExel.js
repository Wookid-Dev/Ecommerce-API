...
function postPreBuyOrderExel(req, res) {
  var orderId = req.body.numeroOrden; //SC_OV_EX_01
  var warehouse = req.body.almacen;
  var address = req.body.direccionEmbarque;
  var city = req.body.ciudad;
  var quantity = req.body.cantidad;
  ...
  var data =
    ...
    `<soap:Body>` +
    `<Colocar_Pre_Orden_Venta xmlns="http://ws.exel.com.mx:8181/">` +
  ...
  axios(config)
    .then(function (response) {
      ...
      console.log(
        xml['soap:Envelope']['soap:Body']['Colocar_Pre_Orden_VentaResponse']['Colocar_Pre_Orden_VentaResult']
      );

      //903193804 y 903193822
    ...
    .catch(function (err) {
      ...
      // let errorXml = parser.parse(err["config"]);
